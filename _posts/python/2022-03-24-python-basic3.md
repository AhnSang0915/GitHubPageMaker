...
<br>
<br>
숫자 두개를 입력받은 뒤 두숫자의 합을 구해보자. 아래 코드를 실행하면 50이 나올거 같지만 문자열을 합친 결과가 나오게 된다.
...
위 결과는 20, 30을 문자열 타입으로 보기 때문이다.  input으로 입력받은 값은 항상 문자이다.
...
## 4.두 숫자의 합 구하기
<br>
<br>input함수를 사용하며 input에 한번에 여러 값을 여러개입력하는 방법을 알아보자.
